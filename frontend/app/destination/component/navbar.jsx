...
const Navbar = ({ districtName, districtid, onTabChange, activeTab }) => {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 left-0 right-0 z-[100] bg-black/95 shadow-lg font-sans backdrop-blur-md">
        ...
        <div className="px-3 md:px-8 py-1 md:py-2 flex flex-col md:flex-row md:items-center md:justify-between gap-1">
          ...
          <div className="relative z-[1000] w-full flex justify-center">
            ...
            <div className="relative z-[1000] w-full max-w-md scale-[0.85] md:scale-100 origin-top">
        ...
        <div className="relative z-10 w-full flex justify-center border-t border-gray-800">
